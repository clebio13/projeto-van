...
CREATE TABLE IF NOT EXISTS `sistema_van`.`AVALIA` (
  ...
  `reserva_ID_RESERVA` INT(5) NOT NULL,
  CONSTRAINT `FK_AVALIA_RESERVA_01` FOREIGN KEY (`reserva_ID_RESERVA`) REFERENCES `sistema_van`.`RESERVA` (`ID_RESERVA`),
  PRIMARY KEY (`COD_AVALIADOR`, `reserva_ID_RESERVA`))
ENGINE = InnoDB;
